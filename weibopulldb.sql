...
CREATE TABLE "crawresult" ("uid" TEXT,"lasttime" INTEGER DEFAULT (null) ,"lastcrawedpage" INTEGER DEFAULT (0) ,"crawinstanceuuid" TEXT DEFAULT (null) );
...
CREATE VIEW "lastcrawfeed" AS    SELECT * FROM crawresult NATURAL JOIN weibofeeds;
